...
export default function sidebar({ admin }) {
    ...
    if (session) {
        ...
        return (
            <div className=''>
                <div className='justify-center py-2 mt-10 px-3 bg-gray-100 dark:bg-gray-800 h-fit w-4/5 mx-auto md:min-h-full rounded-lg  block md:hidden'>
                    <ul className='flex flex-row gap-2 overflow-y-scroll items-center'>
                        <li>
                            <a href="/dashboard" className="flex items-center p-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300 transition">
                        ...
                        <li>
                            <a href="/" className="flex items-center p-1 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300">
                        ...
                        {admin ?
                            <>
                                ...
                                <li>
                                    <a href="/dashboard/create" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300">
                                ...
                                <li>
                                    <a href="/dashboard/delete" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300">
                                ...
                                <li>
                                    <a href="/dashboard/orders" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300">
                ...
                <div className='h-screen min-h-full sticky bg-white dark:bg-neutral-900 hidden md:block'>
                    ...
                    <aside className="w-48 h-5/6 ml-7 my-3 mt-10" aria-label="Sidebar">
                        <div className="overflow-y-auto py-4 px-3 bg-gray-100 dark:bg-gray-800 min-h-full rounded-lg pt-10">
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <a href="/dashboard" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300 transition">
                                        <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                                        <span className="flex-1 ml-3 whitespace-nowrap">Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 active:text-red-300">
                                        <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd"></path></svg>
                                        <span className="flex-1 ml-3 whitespace-nowrap">Shop</span>
                                    </a>
                                </li>
