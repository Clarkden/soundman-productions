            ...
            <div>
                ...
                <div className='flex gap-2 items-baseline  rounded-lg px-2 justify-between drop-shadow-lg border-2 border-black/25 dark:border-white/25 p-2'>
                    ...
                    <div className='flex gap-2'>
                        <button onClick={() => {this.createCheckOutSession; this.setSound(this.audio.source);}} className='text-gray-500 dark:text-red/75'><FontAwesomeIcon icon={faShoppingBag} className="text-green-500 dark:text-green-300  hover:scale-125 transition" /></button>
